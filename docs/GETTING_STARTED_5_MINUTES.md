...
installed but not responding, press **Start Ollama**. If Ollama is running but
has no local model yet, press **Install starter model** and ModelForge will pull
`llama3.2:3b`, save it as the base model, and write a local repair receipt.
